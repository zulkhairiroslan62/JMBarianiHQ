...
export default function Sidebar() {
  ...
  const navLinks = [
    ...
    { path: '/dashboard/recipes', label: 'Recipe BOM', icon: 'ti ti-ri', dot: true },
    { path: '/dashboard/briefing', label: 'AI Briefing', icon: 'ti ti-brain', dot: true },
    { path: '/dashboard/analytics', label: 'Analytics', icon: 'ti ti-chart-infographic', dot: true },
